...
class GRunView extends WatchUi.DataField
{
  ...
  function displayArea(dc, id, type, value, valueArea, dynamicBackgroundColor, dynamicForegroundColor)
  {
    ...
    if (color != null)
    {
      if (dynamicBackgroundColor && !((type == 7 || type == 8 || type == 10 || type == 12 || type == 27) && targetPace == 0))
      {
        bgColor = color;
      ...
      else if (dynamicForegroundColor && !((type == 7 || type == 8 || type == 10 || type == 12 || type == 27) && targetPace == 0))
      {
